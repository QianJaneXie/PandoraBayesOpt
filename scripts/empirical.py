...
def run_bayesopt_experiment(config):
    ...
    return (num_iterations, scaled_constant, cost_history, best_history, regret_history)

wandb.init()
(num_iterations, scaled_constant, cost_history, best_history, regret_history) = run_bayesopt_experiment(wandb.config)
