#!/bin/bash
#SBATCH -J cum_regret_gap_opt                # Job name
#SBATCH -o cum_regret_gap_opt_%j.out         # Output file (%j expands to jobID)
#SBATCH -e cum_regret_gap_opt_%j.err         # Error log file (%j expands to jobID)
...
wandb login
wandb agent 'ziv-scully-group/PandoraBayesOPT/pkqwfhfg' --count 1
conda deactivate